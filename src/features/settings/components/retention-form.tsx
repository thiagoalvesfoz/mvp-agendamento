    ...
    <div className="flex min-h-0 flex-1 flex-col">
      <div className="flex-1 overflow-y-auto px-5 pb-6">
        <p className="mb-5 text-[13px] text-[var(--muted-foreground)]">
          Período após o qual dados pessoais de clientes inativos ficam elegíveis para anonimização
          automática.
        </p>
        ...
        {success && (
          <p className="mt-4 text-center text-[13px] text-green-600">Retenção atualizada.</p>
        )}
      </div>
